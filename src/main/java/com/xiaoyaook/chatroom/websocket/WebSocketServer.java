...
/**
 * created by xiaoyaook on 18-10-1
 */
@Component
public class WebSocketServer {
    ...
    private ChannelHandler webSocketInitializer;
    ...
    public void build() {
        try {
            ...
            serverBootstrap.group(bossGroup, workerGroup) //boss辅助客户端的tcp连接请求  worker负责与客户端之前的读写操作
                    ...
                    .childHandler(webSocketInitializer); //绑定I/O事件的处理类,WebSocketChildChannelHandler中定义
